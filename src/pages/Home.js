    ...
    return (
        <>
            <section className="profile-me-section">
                <h1>Luis Daniel González Zamudio</h1>
                <h3>Graduated from Computer Systems Engineering with experience in web development</h3>
                <h4>Links</h4>
                <p>
                    I am passionate about web development and have experience building web applications,
                    I have a strong understanding of programming languages like HTML, CSS, and JavaScript,
                ...
                <a href="https://www.linkedin.com/in/luis-daniel-gonzalez-zamudio/" target="_blank" rel="noreferrer">
                    <img src="assets/icons/linkedin.png" alt=""/>
                </a>
                <a href="https://github.com/DanielGlzZ" target="_blank" rel="noreferrer">
